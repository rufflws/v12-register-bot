...
.setDescription(`<:667_red:810154774372155412> bu komutu **kullanabilmek** için <@&${settings.roller.teyitcirol}> yetkisine sahip olmalısın.`)
...
message.channel.send(new dc.MessageEmbed().setAuthor(yazı, message.guild.iconURL({dynamic: true})).setTimestamp().setColor("#1f232d").setFooter(message.member.displayName+" tarafından istendi!", message.author.avatarURL).setDescription(top));
